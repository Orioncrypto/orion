...
TRANSLATIONS = $$files(src/qt/locale/orion_*.ts)
...
windows:RC_FILE = src/qt/res/orion-qt-res.rc
...
macx:ICON = src/qt/res/icons/orion.icns
macx:TARGET = "orion-Qt"
