...
The following applies to code changes to the Orion Core project, and is not to be
confused with overall Orion Network Protocol consensus changes.
...
The project leader is the release manager for each Orion Core release.
