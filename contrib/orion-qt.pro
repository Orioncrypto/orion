...
RESOURCES += src/qt/orion.qrc src/qt/orion_locale.qrc

TRANSLATIONS += src/qt/locale/orion_bg.ts \
                src/qt/locale/orion_de.ts \
                src/qt/locale/orion_en.ts \
                src/qt/locale/orion_es.ts \
                src/qt/locale/orion_fi.ts \
                src/qt/locale/orion_fr.ts \
                src/qt/locale/orion_it.ts \
                src/qt/locale/orion_ja.ts \
                src/qt/locale/orion_pl.ts \
                src/qt/locale/orion_pt.ts \
                src/qt/locale/orion_ru.ts \
                src/qt/locale/orion_sk.ts \
                src/qt/locale/orion_sv.ts \
                src/qt/locale/orion_vi.ts \
                src/qt/locale/orion_zh_CN.ts \
                src/qt/locale/orion_zh_TW.ts
