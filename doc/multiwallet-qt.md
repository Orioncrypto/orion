...
In order to support loading of multiple wallets in orion-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is orion.cpp.
...
Changes to orion.cpp
----------------------
orion.cpp is the entry point into orion-qt, and as such, will require some minor modifications to provide hooks for
