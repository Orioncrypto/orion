...
This mechanism has been integrated into Bitcore-Node-Orion which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PIVX-Project/insight-api-orion#web-socket-api](https://github.com/PIVX-Project/insight-api-orion#web-socket-api) 
* API: [https://github.com/PIVX-Project/insight-api-orion#swifttx-transactions](https://github.com/PIVX-Project/insight-api-orion#swifttx-transactions) 
...
By default, the Orion Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Orion Core daemon:
