...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(ZRN);
    unitlist.append(mINDEX);
    unitlist.append(uINDEX);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case mINDEX:
        return QString("morion");
    case uINDEX:
        return QString::fromUtf8("uorion");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ZRN:
            return QString("ZRN");
        case mINDEX:
            return QString("mINDEX");
        case uINDEX:
            return QString::fromUtf8("µINDEX");
        default:
            return QString("???");
        }
    } else {
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ZRN:
            return QString("ZRN");
        case mINDEX:
            return QString("Milli-ZRN (1 / 1" THIN_SP_UTF8 "000)");
        case uINDEX:
            return QString("Micro-ZRN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
