                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Orion Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    // TODO icons
    xbridgeAction = new QAction(QIcon(":/icons/trade"), tr("&Exchange"), this);
    ...
    //xbridgeAction->setVisible(false);
    QSettings settings;
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Orion Core"), this);
    aboutAction->setStatusTip(tr("Show information about Orion Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Orion"));
    ...
    openAction->setStatusTip(tr("Open a Orion: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Orion Core help message to get a list with possible Orion command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Orion Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Orion network", "", count));
}
...
{
    QString strTitle = tr("Orion Core"); // default title
