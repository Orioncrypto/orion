...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Orion Core orion-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  orion-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded orion transaction") + "\n" +
                               "  orion-tx [options] -create [commands]   " + _("Create hex-encoded orion transaction") + "\n" +
                               "\n";
