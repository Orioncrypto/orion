...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000e6e57953f65e0a8bcf0a7292a8a0a0f162954e06c856eb91a580539cbb4"));
    //(280, uint256S("0x"));
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 7 * 60; // Orion: 1 minute
        nTargetSpacing = 1 * 60;  // Orion: 1 minute
        nLastPOWBlock = 85000;
        nMaturity = 5;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Bank of America May Fall by 10% on Slower Growth - 28 July 2018";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1532976338;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2232397;
		

        hashGenesisBlock = genesis.GetHash();
	    assert(hashGenesisBlock == uint256("0x00000e6e57953f65e0a8bcf0a7292a8a0a0f162954e06c856eb91a580539cbb4"));
        assert(genesis.hashMerkleRoot == uint256("0xb86fb939874ba31b243741712059d0b6a55202bee9e37b664efb15d5eb853a08"));
		
		vSeeds.push_back(CDNSSeedData("orion.seeds.mn.zone", "orion.seeds.mn.zone"));
        ...
        // 	BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md - TBD Orion
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Orion: 1 day
        nTargetSpacing = 1 * 60;  // Orion: 1 minute
        nLastPOWBlock = 2000;
        nMaturity = 15;
        nModifierUpdateBlock = 1; 
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet orion addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet orion script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet orion BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet orion BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet orion BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Orion: 1 day
        nTargetSpacing = 1 * 60;        // Orion: 1 minutes
