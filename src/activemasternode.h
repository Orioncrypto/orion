...
#define MASTERNODE_REQUIRED_AMOUNT                 10000
#define MASTERNODE_ACCEPTABLE_INPUTS_CHECK_AMOUNT  9999.99
...
private:
    ...
    /// Ping Masternode with the option to force ping
    bool SendMasternodePing(std::string& errorMessage, bool force = false);
    ...
    /// Get 5000 ZRN input that can be used for the Masternode
