...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Orion features */
        {"Orion", "masternode", &masternode, true, true, false},
        {"Orion", "masternodelist", &masternodelist, true, true, false},
        {"Orion", "mnbudget", &mnbudget, true, true, false},
        {"Orion", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"Orion", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Orion", "mnsync", &mnsync, true, true, false},
        {"Orion", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"Orion", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Oriond, or the -server option to Orion-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6667/\n";
}
