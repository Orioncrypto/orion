...
enum AvailableCoinsType {
    ALL_COINS = 1,
    ONLY_DENOMINATED = 2,
    ONLY_NOT_MASTERNODE_REQUIRED_AMOUNT_IFMN = 3,
    // ONLY_NONDENOMINATED and not 5000 ZRN at the same time
    ONLY_NONDENOMINATED_NOT_MASTERNODE_REQUIRED_AMOUNT_IFMN = 4,
    // find masternode outputs including locked ones (use with caution)
    ONLY_MASTERNODE_REQUIRED_AMOUNT = 5
};
